---
title: "Sensitivity Specificity 2016"
...
table(good.items[,"zero.one"],
      good.items[,"glm.2pl.data.3.a"]) -> cross.tabs.ltm
cross.tabs.ltm
...
table(good.items[,"powers"],
      good.items[,"glm.2pl.data.3.a"]) -> cross.tabs.glm
cross.tabs.glm
...
table(good.items[,"single.digit"],
      good.items[,"glm.2pl.data.3.a"]) -> cross.tabs.rn
cross.tabs.rn
